...
export function isValidHello({ data }) {
...
export function isValidMultiunit({ data }) {
...
export function isValidExpand({ data }) {
	const isEmailValid = !!data.email && EMAIL_PATTERN.test(data.email);
...
export function isValidShowroomTour({ data }) {
	const isFirstNameValid = !!data.firstName;
	const isLastNameValid = !!data.lastName;
	const isEmailValid = !!data.email && EMAIL_PATTERN.test(data.email);
...
export function isValidReservation({ data }) {
	const isFirstNameValid = !!data.firstName;
	const isLastNameValid = !!data.lastName;
	const isEmailValid = !!data.email && EMAIL_PATTERN.test(data.email);
	const isPhoneValid = !!data.phone && PHONE_PATTERN.test(data.phone);
...
export function isValidShowroomRequest({ data }) {
	const isFirstNameValid = !!data.firstName;
	const isLastNameValid = !!data.lastName;
	const isEmailValid = !!data.email && EMAIL_PATTERN.test(data.email);
	const isPhoneValid = !!data.phone && PHONE_PATTERN.test(data.phone);
...
export function isValidHelloSurvey({ data }) {
	return true;
}
