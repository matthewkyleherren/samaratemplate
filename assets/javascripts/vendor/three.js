...
THREE.Matrix4.prototype = {
    ...
    multiplyVector3Array: function(a) {
        for (
            var b = THREE.Matrix4.__v1, c = 0, d = a.length; c < d; c = c + 3
        ) {
            b.x = a[c];
            b.y = a[c + 1];
            b.z = a[c + 2];
...
THREE.BufferGeometry.prototype = {
    ...
    computeBoundingBox: function() {
        ...
        if (a)
            for (
                var b = this.boundingBox, c, d, f, e = 0, g = a.length; e < g; e = e + 3
            ) {
                c = a[e];
                d = a[e + 1];
                f = a[e + 2];
    ...
    computeTangents: function() {
        ...
        if (
            ...
            for (
                var h = this.attributes.tangent.array, i = [], j = [], g = 0; g < e; g++
            ) {
...
THREE.GeometryLoader.prototype = {
    ...
    parse: function(a, b) {
        ...
        var g = a.faces,
            ...
            l = 0;
        if (a.uvs)
            for (e = 0; e < a.uvs.length; e++) a.uvs[e].length && l++;
        for (e = 0; e < l; e++) {
            d.faceUvs[e] = [];
            d.faceVertexUvs[e] = [];
        }
        ...
        if (d.visible !== false) {
            ...
            if (!d.morphTargets && b.position >= 0) {
                ...
                if (f.morphTargetForcedOrder.length) {
                    ...
                    for (
                        g = f.morphTargetInfluences; i < d.numSupportedMorphTargets && i < h.length;
        ...
        for (var hb = 0, rb = a.__webglObjects.length; hb < rb; hb++) {
            ...
            if (ub instanceof THREE.Mesh)
                if (ea instanceof THREE.BufferGeometry) {
                    ...
                    for (
                        var qb = 0, wb = ea.geometryGroupsList.length; qb < wb; qb++
                    ) {
...
THREE.CurvePath.prototype.getPoint = function(a) {
    for (
        var b = a * this.getLength(), c = this.getCurveLengths(), a = 0; a < c.length;
                    ...
                    for (var c = 0; c < a.hierarchy.length; c++) {
                        ...
                        if (
                            ...
                            for (d = 0; d < a.hierarchy[c].keys.length; d++)
                                for (
                                    var i = 0; i <
                                    a.hierarchy[c].keys[d].morphTargets.length; i++
                                ) {
                                    var j =
                ...
                if (h.time <= l) {
                    if (j < l)
                        if (this.loop) {
                            ...
                            for (
                                h = this.getNextKeyWith(c, n, 1); h.time < j;
                    ...
                    if (b && c) {
                        if (c.time <= h) {
                            if (i && this.loop) {
                                ...
                                for (
                                    var m = l.length - 1; c.time < g && c.index !== m;
...
THREE.ArrowHelper = function(a, b, c, d) {
    ...
    this.line = new THREE.Line(f, new THREE.LineBasicMaterial({
        color: d
    }));
    this.add(this.line);
